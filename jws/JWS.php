...
require_once('Algorithm/AlgorithmInterface.php');
require_once('Algorithm/HMACAlgorithm.php');
require_once('Algorithm/RSA_SSA_PKCSv15.php');
require_once('Algorithm/NoneAlgorithm.php');
require_once('Exception/JWSException.php');
require_once('Exception/InvalidSignatureException.php');
require_once('Exception/MalformedSignatureException.php');
require_once('Exception/UnexpectedAlgorithmException.php');
require_once('Exception/UnspecifiedAlgorithmException.php');
